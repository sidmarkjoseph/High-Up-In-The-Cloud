...
public class Requirement1 extends ConnectedVimServiceBase {
    ...
    void displayValues(List<PerfEntityMetricBase> values,
       ...
       try{
         File file = new File ("Requirement1.txt");  
         file.createNewFile();   
        ...
        for (int i = 0; i < values.size(); ++i) {
            ...
            List<PerfSampleInfo> listinfo =
               ...
               writer.write("Sample time range: "
            ...
            for (int vi = 0; vi < listpems.size(); ++vi) {
                ...
                if (pci != null) {
                    writer.write(pci.getNameInfo().getSummary());
                     writer.write("\n");
                }
    ...
    void doRealTime() throws IOException, RuntimeFaultFaultMsg, InterruptedException {
        ...
        if (vmmor != null) {
            ...
            Map<Integer, PerfCounterInfo> counters =
             ...
             PerfCounterInfo pcInfo = vmCounters.get(5);
             counters.put(new Integer(pcInfo.getKey()), pcInfo);
             pcInfo = vmCounters.get(32);
             counters.put(new Integer(pcInfo.getKey()),pcInfo);
